	...
	*****************************************
	...
	display "`can'"
	cd "$path_fuzzy_data"
	capture erase `can'_all.dta
	capture erase `can'_`year'.dta
	capture erase data_`can'_`year'.dta
	capture erase `can'new_`year'.dta
	capture erase inter_`year'.dta
	capture erase inter_`year'_wide.dta
		
		
	capture erase fuzzy_0.6_*
	capture erase fuzzy_0.7_*
	capture erase fuzzy_0.8_*
	capture erase fuzzy_0.9_*
	}
	}
	...
	* (a) Cases in 2015 for which candidate_id_min != candidate_id_max
	 ...
	 * (iii) Generate Output for Jonas Röllin
		...
		order canton indicator candidateid_threshold_min candidateid_threshold_opt candidateid_threshold_max candidateid_ candidateid_threshold_opt_2011	candidateid_threshold_min_2011	candidateid_threshold_max_2011	candidateid__2011 Vorname Nachname  id_Stata id_recoded unsicher Kommentar Geschlecht Geburtsjahr Listenbezeichnung Gemeinde Wahljahr canton indicator_2011 candidateid_threshold_opt_2011 candidateid_threshold_min_2011 candidateid_threshold_max_2011 candidateid__2011 id_Stata_2011  unsicher_2011 Kommentar_2011 Listenbezeichnung_2011
		...
		*cd "$datapath"
		...
		drop id_recoded_2011 candidateid_threshold_opt_2011	candidateid_threshold_min_2011	candidateid_threshold_max_2011	candidateid__2011 indicator_2011	id_Stata_2011	unsicher_2011	Kommentar_2011	Listenbezeichnung_2011
		export excel using "./4 fuzzy merge to check vasco/erf_vasco_`can'.xlsx", firstrow(variables) replace
		restore
		}
