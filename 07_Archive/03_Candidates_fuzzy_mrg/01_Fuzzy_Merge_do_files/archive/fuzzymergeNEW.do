...
foreach threshold in `thresholds'{
	...
	* (vii) Generate outfile for typists
	...
	local keepErfasser indicator candidateid_threshold_opt candidateid_threshold_min candidateid_threshold_max candidateid_ Vorname Nachname id_Stata id_recoded unsicher Kommentar Geschlecht Geburtsjahr Listenbezeichnung Gemeinde Wahljahr
	order `keepErfasser'
	keep `keepErfasser'
