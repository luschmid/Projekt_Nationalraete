...
local computer "Lukas" // 


local vals "1934 1943 1960 1962 1963 1964 1966 1967 1970 1973 1976 1979_1980 1980_1981 1982 1983 1984 1985 1986 1987 1988 1989 1990 1991 1992 1993 1994 1995 1996 1997 1998 1998_1999 1999 2000 2001 2002 2003"
foreach val in `vals'{
...
noisily display "Reshape long new Group:" "`k'"
sort PID year
gen id_new=_n
keep if year==(`yr'-1) // for all years before 1999
*keep if year==(`yr') // for all years after 1999
...
preserve
keep if _merge<3
if `yr'==1934 save "$path/02_Processed_data/10_Directors_1934_2003/`computer'/pers_comp_notmerged.dta", replace
else {
...
forvalues k = 1(1)`n_groups'{
noisily display "Reshape wide new Group:" "`k'"
preserve
keep if grp==`k'
...
if `yr'==1934 save "$path/02_Processed_data/10_Directors_1934_2003/`computer'/temp_allyears.dta", replace
else {
