...
quietly{
local n_groups 30 // define number of groups to cut person file in order to speed up reshape

local vals "1999 2000 2002 2003"
foreach val in `vals'{
noisily display "new year: " "`val'"
...
save "$path/02_Processed_data/10_Directors_1934_2003/temp_companies.dta", replace

* (b) import persons file 


forvalues k = 1(1)`n_groups'{
noisily display "new group: " "`k'"
...
if `i'==1 & `k'==1 save "$path/02_Processed_data/10_Directors_1934_2003/temp.dta", replace 
else{
append using "$path/02_Processed_data/10_Directors_1934_2003/temp.dta"
save "$path/02_Processed_data/10_Directors_1934_2003/temp.dta", replace 
}
restore
}
...
use "$path/02_Processed_data/10_Directors_1934_2003/temp.dta", clear
merge m:1 companiesid using  "$path/02_Processed_data/10_Directors_1934_2003/temp_companies.dta"

preserve
keep if _merge<3
if `yr'==1999 save "$path/02_Processed_data/10_Directors_1934_2003/pers_comp_notmerged.dta", replace
else {
append using "$path/02_Processed_data/10_Directors_1934_2003/pers_comp_notmerged.dta", force
save "$path/02_Processed_data/10_Directors_1934_2003/pers_comp_notmerged.dta", replace
}
restore
...
if `k'==1 save "$path/02_Processed_data/10_Directors_1934_2003/temp_wide.dta", replace 
else{
append using "$path/02_Processed_data/10_Directors_1934_2003/temp_wide.dta"
save "$path/02_Processed_data/10_Directors_1934_2003/temp_wide.dta", replace 
}
restore
}

use "$path/02_Processed_data/10_Directors_1934_2003/temp_wide.dta", clear 
...
if `yr'==1999 save "$path/02_Processed_data/10_Directors_1934_2003/temp_allyears.dta", replace
else {
append using "$path/02_Processed_data/10_Directors_1934_2003/temp_allyears.dta", force
save "$path/02_Processed_data/10_Directors_1934_2003/temp_allyears.dta", replace
} 
}
** export
