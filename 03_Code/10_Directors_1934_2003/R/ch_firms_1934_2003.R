...
mun$dummy_agglo <- ifelse(mun$gdenr %in% mun_agglo$ID0, 1, 0)
agglo_lookup <- setNames(mun$dummy_agglo, mun$gdenr)
...
canton <- mun %>% left_join(mun_2012 %>% select(gdenr_2012, ctn, ctnnr), by = c("ID0" = "gdenr_2012"))
...
### Firm to firm network analysis (in LCC)
  ...
  # Print to .tex file
    print(latex_table,
          include.rownames = FALSE,  
          file = "C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/firm_LCC_summary.tex",
          booktabs = TRUE)
...
### Firm-to-firm : node-level measures
  ...
  # Output directory
    outdir <- "C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results"
...
### Direct edge counts  (share within/across cantons)
    ...
    # Empty list to hold results
     ...
     # Plot that 
        ...
        print(p_both)
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_within_vs_cross.pdf", p_both, width = 11.69, height = 11.69)
...
### Direct weighted edge counts (within/across cantons)
    ...
    # Plot that
        ...
        print(p_both_w)
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_within_vs_cross_weighted.pdf", p_both_w, width = 11.69, height = 11.69)
...
### Direct edge counts  (share within/across languages)
    ...
    # Storage for summary per year
        ...
        print(p_both_lang)
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_within_vs_cross_lang.pdf", p_both_lang, width = 11.69, height = 11.69)
...
### Direct weighted edge counts (within/across lang)
    ...
    weighted_summary_lang <- list()
        ...
        print(p_both_w)
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_within_vs_cross_lang_weighted.pdf", p_both_w, width = 11.69, height = 11.69)        
...
### Comparing within/across cantons & within/across language regions 
        ...
        print(p_unw)
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_within_cross_canton_language_unweighted.pdf", p_unw, width = 11.69, height = 11.69)
        ...
        print(p_w)
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_within_cross_canton_language_weighted.pdf", p_w, width = 11.69, height = 11.69)
...
### E-I Index weighted
    ...
    ### Plot that
      ...
      # Save PDF for Overleaf
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_ei_unw_vs_w.pdf", p_ei, width = 11.69, height = 11.69)
...
### E-I Index for Language weighted
    ...
    ### Plot that
        ...
        # Save PDF for Overleaf
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/fig_ei_unw_vs_w_lang.pdf", p_ei, width = 11.69, height = 11.69)
...
### Matrices (26x26 at canton level, diag is within, rest is across)       
      ...
      ### All years
        ...
        # Loop over all years
        outdir <- "C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/canton_heatmaps"
        ...
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/canton_heatmaps/canton_heatmaps_selected_years.pdf", final_plot,
...
### Assortativity by canton & language
    ...
    ### Combined plot
        ...
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/assortativity_graph.pdf", assortativity_graph, width = 11.69, height = 11.69)
...
# Note: Assortativity is a global correlation measure, while node-level homophily is the average of local shares (node-level)
  ...
  # Plot that
        ...
        ggsave("C:/Users/schmutzy/Desktop/Projekt Nationalräte/02_Processed_data/10_Directors_1934_2003/32_Network_descriptive_paper/results/homophily_graph.pdf", homophily_graph, width = 11.69, height = 11.69)
...
###  Subsample of mun close to borders
  ...
  #  Maps with shade of colours
          tm_shape(mun) +
            tm_fill("dist_to_canton_border", palette = "viridis", style = "quantile") +
            tm_borders(lwd = 0.3, col = "grey") +
            tm_shape(internal_borders) +
...
# Network analysis, but in subsamples
      # 5km    
          # Create lookup: mun_id -> dummy_5km
          dummy_lookup <- setNames(mun$dummy_5km, mun$gdenr_2012)  # replace ID0 with your mun ID variable
          
          for (year in years) {
            g <- get(paste0("g_firms_lcc_", year))
            
            # Attach dummy to vertices
            V(g)$dummy_5km <- dummy_lookup[V(g)$gdenr_2012]  # adjust 'mun_id' to match your graph vertex attribute
            
            assign(paste0("g_firms_lcc_", year), g)  # save back
          }
          
          cross_summary_5km <- list()
          
          for (year in years) {
            g <- get(paste0("g_firms_lcc_", year))
            
            # Induce subgraph with only vertices inside 5 km
            g_sub <- induced_subgraph(g, vids = which(V(g)$dummy_5km == 1))
            
            if (ecount(g_sub) == 0 || vcount(g_sub) == 0) {
              cross_summary_5km[[as.character(year)]] <- data.frame(
            ...
            # Vertex canton labels
            ctn <- V(g_sub)$ctn
            ep <- ends(g_sub, E(g_sub), names = FALSE)
            
            bad  <- is.na(ctn[ep[,1]]) | is.na(ctn[ep[,2]]) | ctn[ep[,1]] == "" | ctn[ep[,2]] == ""
            diff <- ctn[ep[,1]] != ctn[ep[,2]]
            
            E(g_sub)$cross_canton <- ifelse(bad, NA_integer_, as.integer(diff))
            
            within_cnt <- sum(E(g_sub)$cross_canton == 0L, na.rm = TRUE)
            cross_cnt  <- sum(E(g_sub)$cross_canton == 1L, na.rm = TRUE)
            tot_defined <- within_cnt + cross_cnt
          ...
          cross_summary_df_5km <- dplyr::bind_rows(cross_summary_5km)
          print(cross_summary_df_5km)
