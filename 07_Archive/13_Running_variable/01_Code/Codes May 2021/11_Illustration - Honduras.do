...
gen votemargin_rel1= Votemargin/total_electoral
gen votemargin_rel2= Votemargin/votaron
gen votemargin_rel3= Votemargin*no_seats/total_electoral 
gen votemargin_rel4= Votemargin*no_seats/votaron
...
if "`z'" != "elected_F1" & "`z'" != "Department_18"{
	noisily esttab p1 p1_div2 p2 p2_div2 using "$path\05_Texts_and_presns\01_Running_variable\tables\\`margin'_balance_hn.tex", ///
