...
local vals "1999 2000 2001 2002 2003"
foreach val in `vals'{
...
preserve
keep if _merge<3
if `yr'==1934 save "$path\02_Processed_data\10_Directors_1934_2003\pers_comp_notmerged.dta", replace
else {
...
export delimited Sugarcube_Companies.csv, delimiter(";") replace
