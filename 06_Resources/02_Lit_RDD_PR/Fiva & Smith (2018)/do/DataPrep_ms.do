...
use dta/NSD2405_en_F7.dta, clear // Fiva Smith dataset from Statistics Norway: https://search.nsd.no/study/NSD2405

rename *, lower					// ms
rename pid_nsd pid_NSD 			// ms
rename pid_nsd2 pid_NSD2		// ms
rename hometownid hometownID	// ms
...
tab count								// ms: new line of code
drop if count>1							// ms: new line of code
...
drop pid_v6 ever_deputy // ms: these variables create code to break down
