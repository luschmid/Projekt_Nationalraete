...
preserve
keep if _merge<3
if `yr'==2003 save "$path/02_Processed_data/10_Directors_1934_2003/`computer'/pers_comp_notmerged.dta", replace
else {
...
if `yr'==2003 save "$path/02_Processed_data/10_Directors_1934_2003/`computer'/temp_allyears.dta", replace
else {
