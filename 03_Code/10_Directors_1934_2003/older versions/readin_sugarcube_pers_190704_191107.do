...
foreach val in 1934 1943 1960 1962 1963 1964 1966 1967 1970 1973 1976 1979_1980 1980_1981 1998_1999 {
	import delim using "$path\01_Raw_data\10_Directors_1934_2003\Pre\Kern_`val'_persons.csv", delimiters(";") clear
...
** 1) Merge on PLZ: Discard information on WHEN PLZ was in use (available back until 1986)-- > take average coordinates within PLZ (over time)
...
/*
    ...
    -----------------------------------------
    not matched                       381,393
        from master                   381,223  (_merge==1)
        from using                        170  (_merge==2)

    matched                         3,838,415  (_merge==3)
    -----------------------------------------
*/
...
drop gdename1 gdename2 gdename3 gdename4 gdename5 gdename6
forv k = 1(1)6 { 				// create gdenames for subsequent merging (without canton-indication in parentheses)
...
drop gdename1 gdename2 gdename3 gdename4 gdename5 gdename6 // come from using data and are not used at this moment
drop if _merge==2
...
tab gdename8
tab gdename9
drop gdename7 gdename8 gdename9 // empty
...
forv j = 1(1)6 {  // merge on first standardized municipality names
	sort gdename`j' year
...
forv p = 1(1)6 {  // delete parentheses
...
forv q = 1(1)6 {  // merge on first standardized municipality names without parentheses
	sort gdename`q' year
...
forv t = 1(1)5 {   // delete potential information in parentheses (often cantonal info)
...
preserve
keep if (_merge_3a1 == 3 | _merge_3a2 == 3 | _merge_3a3 == 3 | _merge_3a4 == 3 | _merge_3a5 == 3 | _merge_3a6 == 3 | ///
 _merge_3b1 == 3 | _merge_3b2 == 3 | _merge_3b3 == 3 | _merge_3b4 == 3 | _merge_3b5 == 3 | _merge_3b6 == 3 | ///
 ...
 _merge_3c40 == 3 | _merge_3c41 == 3 | _merge_3c42 == 3 | _merge_3c43 == 3 | _merge_3c44 == 3 | ///
 _merge_3c50 == 3 | _merge_3c51 == 3 | _merge_3c52 == 3 | _merge_3c53 == 3 | _merge_3c54 == 3)
 
gen geo = 31 if (_merge_3a1 == 3 | _merge_3a2 == 3 | _merge_3a3 == 3 | _merge_3a4 == 3 | _merge_3a5 == 3 | _merge_3a6 == 3) // Step 3: use information after splitting
replace geo = 32 if geo==. & (_merge_3b1 == 3 | _merge_3b2 == 3 | _merge_3b3 == 3 | _merge_3b4 == 3 | _merge_3b5 == 3 | _merge_3b6 == 3) // Step 3: use information after splitting w\o parentheses
...
drop if (_merge_3a1 == 3 | _merge_3a2 == 3 | _merge_3a3 == 3 | _merge_3a4 == 3 | _merge_3a5 == 3 | _merge_3a6 == 3 | ///
 _merge_3b1 == 3 | _merge_3b2 == 3 | _merge_3b3 == 3 | _merge_3b4 == 3 | _merge_3b5 == 3 | _merge_3b6 == 3 | ///
 _merge_3c10 == 3 | _merge_3c11 == 3 | _merge_3c12 == 3 | _merge_3c13 == 3 | _merge_3c14 == 3 | ///
 _merge_3c20 == 3 | _merge_3c21 == 3 | _merge_3c22 == 3 | _merge_3c23 == 3 | _merge_3c24 == 3 | ///
 _merge_3c30 == 3 | _merge_3c31 == 3 | _merge_3c32 == 3 | _merge_3c33 == 3 | _merge_3c34 == 3 | ///
...
/*
** Prepare sub-datasets for manual checks and coding etc. **

* Append the different parts of the data *
* Start with missing data PLZ4 & city
* Add all data from successfull merges with PLZ4: Persons-Geo1.dta
* Add data from successfull merges in rounds 2a & 2b; Persons-Geo2a.dta & Persons-Geo2b.dta
* Add data from successfull merges in rounds 3a, 3b & 3c: Persons-Geo3abc.dta
* Add data that does not merge after three rounds
...
append using "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo2a.dta"
append using "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo2b.dta"
append using "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo3abc.dta"
append using "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo_nomerge-after3.dta"


gen geo = -99 if gdename == "" & PLZ4 == .
replace geo = 1 if _merge_PLZ == 3  			// Step 1) source of information for geo-match: PLZ match
replace geo = 21 if _merge_2a == 3 & geo==.  	// Step 2a) match on municipality name (without splitting)
replace geo = 22 if _merge_2b == 3 & geo==.  	// Step 2b) match on municipality name without parentheses (without splitting)
replace geo = 31 if geo==. & (_merge_3a1 == 3 | _merge_3a2 == 3 | _merge_3a3 == 3 | _merge_3a4 == 3 | _merge_3a5 == 3 | _merge_3a6 == 3) // Step 3: use information after splitting
replace geo = 32 if geo==. & (_merge_3b1 == 3 | _merge_3b2 == 3 | _merge_3b3 == 3 | _merge_3b4 == 3 | _merge_3b5 == 3 | _merge_3b6 == 3) // Step 3: use information after splitting w\o parentheses
replace geo = 33 if geo==. & ///
(_merge_3c10 == 3 | _merge_3c11 == 3 | _merge_3c12 == 3 | _merge_3c13 == 3 | _merge_3c14 == 3 | ///
 _merge_3c20 == 3 | _merge_3c21 == 3 | _merge_3c22 == 3 | _merge_3c23 == 3 | _merge_3c24 == 3 | ///
 _merge_3c30 == 3 | _merge_3c31 == 3 | _merge_3c32 == 3 | _merge_3c33 == 3 | _merge_3c34 == 3 | ///
 _merge_3c40 == 3 | _merge_3c41 == 3 | _merge_3c42 == 3 | _merge_3c43 == 3 | _merge_3c44 == 3 | ///
 _merge_3c50 == 3 | _merge_3c51 == 3 | _merge_3c52 == 3 | _merge_3c53 == 3 | _merge_3c54 == 3)       // Step 3: use information after splitting, after eliminating info in parentheses
replace geo = -9 if geo==.

save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_alldata.dta", replace

// matches in 3a-c
preserve
keep if geo==31
keep PID year PLZ4 gdename *_3a*
order PID year PLZ4 gdename *_3a*
save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_3a.dta", replace
restore
preserve
keep if geo==32
keep PID year PLZ4 gdename *_3b*
order PID year PLZ4 gdename *_3b*
save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_3b.dta", replace
restore
preserve
keep if geo==33
keep PID year PLZ4 gdename *_3c*
order PID year PLZ4 gdename *_3c*
save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_3c.dta", replace
restore
// no-matches (geo==-9)
preserve
keep if geo==-9
keep PID year PLZ4 gdename gdename_std* gdename1 gdename2 gdename3 gdename4 gdename5
order PID year PLZ4 gdename gdename_std*
save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_miss.dta", replace
restore

tab year geo

* analyze & identify missing geo cases
// take those with non-missing PLZ4 information
preserve
keep if geo==-9 & PLZ4!=.
gen count = 1
collapse (sum) count, by(gdename PLZ4)
bysort PLZ4: egen countPLZ = total(-count)
order countPLZ count PLZ4 gdename
sort countPLZ PLZ4
save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_miss_wPLZ_check.dta", replace 
restore

// check those merged in round 3a
use "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_3a.dta", clear
keep PID year gdename gdenr_2018_3a* _merge_3a* gdename_3a*
reshape long gdename_3a gdenr_2018_3a _merge_3a, i(PID year gdename) j(groupID) 
drop if _merge_3a!=3
drop year _merge_3a
order PID groupID gdename gdename_3a gdenr_2018_3a 
gen count = -1
collapse (sum) count, by(gdename gdename_3a gdenr_2018_3a)
order count  gdename gdename_3a gdenr_2018_3a
sort count gdename_3a
save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_3a_check", replace 

// check those merged in round 3c
use "$path\02_Processed_data\08_Municipalities\Gde_GdeNr2018_Centroid_1931-2018.dta", clear // work-around: re-import the names of merged municipalities according to the geo-dataset for manual comparisons
keep if year == 2018
keep gdenr_2018 gdename
sort gdenr_2018
save "$path\02_Processed_data\10_Directors_1934_2003\Gdename_GdeNr2018.dta", replace

use "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_3c.dta", clear
keep PID year gdename gdenr_2018_3c* _merge_3c* gdename_3c*
reshape long gdename_3c gdenr_2018_3c _merge_3c, i(PID year gdename) j(groupID) 
keep if _merge_3c==3
gen c = -1
collapse (sum) c, by(PID year gdename gdenr_2018_3c)
rename gdenr_2018_3c gdenr_2018
rename gdename gdename_sugar
sort gdenr_2018
merge m:1 gdenr_2018 using "$path\02_Processed_data\10_Directors_1934_2003\Gdename_GdeNr2018.dta"
rename gdename gdename_geo
rename gdename_sugar gdename
keep if _merge == 3
drop _merge
order c PID year gdename gdename_geo
sort c gdename PID year
save "$path\02_Processed_data\10_Directors_1934_2003\Persons-Geo4_3c_check", replace 
*/
...
replace gdename = "saint sulpice (ne)" if gdename == "st sulpice"
...
replace gdename = "sils im engadin/segl" if gdename == "sils"
...
replace gdename = "ried bei kerzers" if gdename == "ried"
...
replace gdename = "sumiswald" if gdename == "wisen"
replace gdename = "affoltern am albis" if gdename == "affoltern"
replace gdename = "sainte croix" if gdename == "ste-croix"
...
replace gdename = "hausen (ag)" if gdename == "hausen"
...
replace gdename = "vuisternens devant romont" if gdename == "vuisternens"
...
replace gdename = "oetwil an der limmat" if gdename == "oetwil"
...
replace gdename = "muenchwilen (ag)" if gdename == "munchwilen"
...
replace gdename = "kilchberg (zh)" if gdename == "kilchherg"
...
replace gdename = "langnau im emmental" if gdename == "langnau i/e."
replace gdename = "neuchatel" if gdename == "le coudre"
...
replace gdename = "romanel sur lausanne" if gdename == "romanel"
...
replace gdename = "uitikon" if gdename == "waldegg"
...
replace gdename = "kilchberg (zh)" if gdename == "killchberg"
...
// a few ambiguous cases (more than one municipality possible - create new datasets and append)
drop if n_gde == 1
replace gdename = "saint sulpice (ne)" if gdename == "st sulpice"
replace gdename = "saint sulpice (ne)" if gdename == "st. sulpice"
replace gdename = "sils im engadin/segl" if gdename == "sils"
...
drop if n_gde == 2
replace gdename = "hausen bei brugg" if gdename == "hausen"
replace gdename = "ried bei brig" if gdename == "ried"
...
countPLZ4 GdeNr_E_CNTR GdeNr_N_CNTR gdenr_2018 gdename_used geo n_gde
...
keep if _merge == 3
replace geo = 92
replace GdeNr_E_CNTR = E_CNTR
replace GdeNr_N_CNTR = N_CNTR
gen gdename_used = gdename
keep PID year titlejob firstname lastname address address2 alternateaddress PLZ4 city companiesid functions page ///
countPLZ4 GdeNr_E_CNTR GdeNr_N_CNTR gdenr_2018 gdename_used geo n_gde
...
gen gdename_used = gdename
keep PID year titlejob firstname lastname address address2 alternateaddress PLZ4 city companiesid functions page ///
countPLZ4 GdeNr_E_CNTR GdeNr_N_CNTR gdenr_2018 gdename_used geo nCH
...
// correct gdename after PLZ4 correction
...
replace gdename = "langnau (zh)" if gdename_3a == "langnau a. a, atlantis parkhotel ag, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a. a, barverkaufs ag, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a. a, fivat ag, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a. a, melitta ag, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a. a, notag, e. nebel orientteppich transithandel ag, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a. a, texsana reinigung hirschmatt luzern ag, luzern"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a. a, trevin ag, treuhand inkasso, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a.a, profib ag, hinwil"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a.a, profib ag, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a.a, reflo ag, zuerich"
replace gdename = "langnau (zh)" if gdename_3a == "langnau a.a, skilift ag tschappina, tschappina"
replace gdename = "langnau (be)" if gdename_3a == "langnau i. e, tuileries de corbieres s.a., corbieres"
replace gdename = "langnau (be)" if gdename_3a == "langnau i.e, holdingges. pilatus ag, burgdorf"
...
replace gdename = "muri (be)" if gdename_3a == "mud b. b, eika ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muni b. b, j. hirter co ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muni b. b, schoenholzer ag, bern"
replace gdename = "muralto" if gdename_3a == "muralto , tipografia alla motta s.a., locarno"
replace gdename = "muri (be)" if gdename_3a == "muri b b, berner handelsbank ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, bauges. nubag ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, bauges. nuhag ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, eika ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, f. anker cie ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, f. anker cie. ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, financiere de participations internationales s.a., bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, garage egghoelzli ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, imlo immobilien ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, j. hinter co ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, j. hirter co ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, j. hitter co ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, jucker cie ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, kaiser co ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, privatklinik engeried, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, rud. kull ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, schoenholer ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. b, schoenholzer ag, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. e, privatklinik engeried, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b. r, privatklinik engeried, bern"
replace gdename = "muri (be)" if gdename_3a == "muri b., bern"
...
// replace gdename in case of correct match in round 3a
...
forv j = 1(1)6 {  // eliminate information from incorrect matches in 3a
	replace E_CNTR_3a`j' = . if wrong3a == 1	
	replace N_CNTR_3a`j' = . if wrong3a == 1
	replace gdenr_2018_3a`j' = . if wrong3a == 1
	replace gdename_3a`j' = "" if wrong3a == 1
}
...
forv j = 1(1)6 {  // accept information on correct matches in 3a
	replace E_CNTR_3a = E_CNTR_3a`j' if wrong3a == 0 & E_CNTR_3a`j' != .
	replace N_CNTR_3a = N_CNTR_3a`j' if wrong3a == 0 & N_CNTR_3a`j' != .
	replace gdenr_2018_3a = gdenr_2018_3a`j' if wrong3a == 0 & gdenr_2018_3a`j' != .
} 
replace GdeNr_E_CNTR = E_CNTR_3a if wrong3a == 0  // correct matches from 3a
replace GdeNr_N_CNTR = N_CNTR_3a if wrong3a == 0
// matches from newly merged PLZ are already in variable (wrong3a==.)
...
gdename_3b1 gdename_3b2 gdename_3b3 gdename_3b4 gdename_3b5 gdename_3b6 gdenr_2018_3a1 E_CNTR_3a1 N_CNTR_3a1 _merge_3a1 gdename_3a1 ///
gdenr_2018_3a2 E_CNTR_3a2 N_CNTR_3a2 _merge_3a2 gdename_3a2 gdenr_2018_3a3 E_CNTR_3a3 N_CNTR_3a3 _merge_3a3 gdename_3a3 ///
gdenr_2018_3a4 E_CNTR_3a4 N_CNTR_3a4 _merge_3a4 gdename_3a4 gdenr_2018_3a5 E_CNTR_3a5 N_CNTR_3a5 _merge_3a5 gdename_3a5 ///
gdenr_2018_3a6 E_CNTR_3a6 N_CNTR_3a6 _merge_3a6 gdename_3a6 gdenr_2018_3b1 E_CNTR_3b1 N_CNTR_3b1 _merge_3b1 ///
gdenr_2018_3b2 E_CNTR_3b2 N_CNTR_3b2 _merge_3b2 gdenr_2018_3b3 E_CNTR_3b3 N_CNTR_3b3 _merge_3b3 ///
gdenr_2018_3b4 E_CNTR_3b4 N_CNTR_3b4 _merge_3b4 gdenr_2018_3b5 E_CNTR_3b5 N_CNTR_3b5 _merge_3b5 ///
gdenr_2018_3b6 E_CNTR_3b6 N_CNTR_3b6 _merge_3b6 gdenr gdename_1std6 gdename_3c
...
gdename_std1 gdename1 gdename2 gdename3 gdename4 gdename5 gdename6 gdename groupID_3c gdenr_2018_3c E_CNTR_3c N_CNTR_3c _merge_3c geo
...
// either info contained refers to company mandate, or to duplicate municipality that does not match information (see hand-codings)
drop if PID == 35546 & year == 1963 & gdename == "biel ., schnyder liechti ag, biel" & gdenr_2018_3c == 2764
drop if PID == 35546 & year == 1963 & gdename == "biel ., schnyder liechti ag, biel" & gdenr_2018_3c == 6077
drop if PID == 27160 & year == 1959 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 1125
drop if PID == 27160 & year == 1959 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 4003
drop if PID == 27160 & year == 1959 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 83
drop if PID == 27160 & year == 1959 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 3271
drop if PID == 31168 & year == 1961 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 3271
drop if PID == 31168 & year == 1961 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 4003
drop if PID == 31168 & year == 1961 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 1125
drop if PID == 31168 & year == 1961 & gdename == "blockmetall ag, buchs" & gdenr_2018_3c == 83
drop if PID == 37008 & year == 1982 & gdename == "campo (bienio)" & gdenr_2018_3c == 5307
drop if PID == 34680 & year == 1997 & gdename == "campo (blenlo)" & gdenr_2018_3c == 5307
drop if PID == 863 & year == 1933 & gdename == "couvet (ge)" & gdenr_2018_3c == 6512
drop if PID == 38285 & year == 1966 & gdename == "engleiten, bad ischl, schauberger biotechnik ag, wetzikon" & gdenr_2018_3c == 121
drop if PID == 38285 & year == 1966 & gdename == "engleiten, bad ischl, schauberger biotechnik ag, wetzikon" & gdenr_2018_3c == 4611
drop if PID == 5442 & year == 1996 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 5607 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 22451 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 56334 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 61485 & year == 2000 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 63737 & year == 1995 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 64410 & year == 2000 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 67222 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 70569 & year == 2000 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 73094 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 103880 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 105105 & year == 1999 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 105132 & year == 1998 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 106090 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 117650 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 136495 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 136496 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 157817 & year == 1999 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 158295 & year == 1995 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 159350 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 168860 & year == 1997 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 182190 & year == 1992 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 186848 & year == 1999 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 189121 & year == 2000 & gdename == "forel (lavauz)" & gdenr_2018_3c == 2054
drop if PID == 167777 & year == 1995 & gdename == "forel (uvaux)" & gdenr_2018_3c == 2054
drop if PID == 4157 & year == 1942 & gdename == "forel (vd)" & gdenr_2018_3c == 2054
drop if PID == 47649 & year == 1972 & gdename == "forel(lavaux)" & gdenr_2018_3c == 2054
drop if PID == 63760 & year == 1975 & gdename == "forel(lavaux)" & gdenr_2018_3c == 2054
drop if PID == 74308 & year == 1979 & gdename == "forel(lavaux)" & gdenr_2018_3c == 2054
drop if PID == 30493 & year == 1959 & gdename == "fribourg sipra s.a., rossens" & gdenr_2018_3c == 2236
drop if PID == 30493 & year == 1959 & gdename == "fribourg sipra s.a., rossens" & gdenr_2018_3c == 5830
drop if PID == 37461 & year == 1962 & gdename == "geneve arts menagers s.a. (amsa), chene bougeries" & gdenr_2018_3c == 6612
drop if PID == 27564 & year == 1965 & gdename == "glion s.1. le bluet s.a. villeneuve vd., villeneuve" & gdenr_2018_3c == 5414
drop if PID == 27564 & year == 1965 & gdename == "glion s.1. le bluet s.a. villeneuve vd., villeneuve" & gdenr_2018_3c == 2044
drop if PID == 1196 & year == 1933 & gdename == "granges (vd)" & gdenr_2018_3c == 6248
drop if PID == 2516 & year == 1942 & gdename == "granges (vd)" & gdenr_2018_3c == 6248
drop if PID == 4403 & year == 1933 & gdename == "muenster (lu)" & gdenr_2018_3c == 6077
drop if PID == 8000 & year == 1933 & gdename == "muenster (lu)" & gdenr_2018_3c == 6077
drop if PID == 48147 & year == 1966 & gdename == "muri" & gdenr_2018_3c == 4236
drop if PID == 7203 & year == 1942 & gdename == "oberdorf (basel)" & gdenr_2018_3c == 2553
drop if PID == 7203 & year == 1942 & gdename == "oberdorf (basel)" & gdenr_2018_3c == 1508
drop if PID == 13861 & year == 1942 & gdename == "oberdorf (basel)" & gdenr_2018_3c == 2553
drop if PID == 13861 & year == 1942 & gdename == "oberdorf (basel)" & gdenr_2018_3c == 1508
drop if PID == 13412 & year == 1959 & gdename == "oberdorf (bld)" & gdenr_2018_3c == 1508
drop if PID == 13412 & year == 1959 & gdename == "oberdorf (bld)" & gdenr_2018_3c == 2553
drop if PID == 13414 & year == 1959 & gdename == "oberdorf (bld)" & gdenr_2018_3c == 1508
drop if PID == 13414 & year == 1959 & gdename == "oberdorf (bld)" & gdenr_2018_3c == 2553
drop if PID == 13040 & year == 1942 & gdename == "oberwil (basel)" & gdenr_2018_3c == 4571
drop if PID == 13040 & year == 1942 & gdename == "oberwil (basel)" & gdenr_2018_3c == 4074
drop if PID == 18228 & year == 1942 & gdename == "oberwil (basel)" & gdenr_2018_3c == 4074
drop if PID == 18228 & year == 1942 & gdename == "oberwil (basel)" & gdenr_2018_3c == 4571
drop if PID == 12189 & year == 1959 & gdename == "oberwil (bid)" & gdenr_2018_3c == 4074
drop if PID == 12189 & year == 1959 & gdename == "oberwil (bid)" & gdenr_2018_3c == 4571
drop if PID == 13165 & year == 1959 & gdename == "oberwil (bid)" & gdenr_2018_3c == 4074
drop if PID == 13165 & year == 1959 & gdename == "oberwil (bid)" & gdenr_2018_3c == 4571
drop if PID == 13308 & year == 1959 & gdename == "oberwil (bid)" & gdenr_2018_3c == 4571
drop if PID == 13308 & year == 1959 & gdename == "oberwil (bid)" & gdenr_2018_3c == 4074
drop if PID == 6327 & year == 1959 & gdename == "paris fromages gervais s.a.. extension suisse, carouge" & gdenr_2018_3c == 6608
drop if PID == 29830 & year == 1962 & gdename == "rees a.r, luftseilbahn erlenbach i.s. stockhorn ag (lest), erlenbach" & gdenr_2018_3c == 151
drop if PID == 31587 & year == 1963 & gdename == "rees a.r, luftseilbahn erlenbach i.s. stockhorn ag (lest), erlenbach" & gdenr_2018_3c == 151
drop if PID == 17810 & year == 1942 & gdename == "reinach (basel)" & gdenr_2018_3c == 4141
drop if PID == 8056 & year == 1959 & gdename == "reinach (bid)" & gdenr_2018_3c == 4141
drop if PID == 39897 & year == 1966 & gdename == "rheinfelden (deutschland)" & gdenr_2018_3c == 4258
drop if PID == 4342 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 225
drop if PID == 4342 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 2857
drop if PID == 4342 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 1097
drop if PID == 4342 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 2582
drop if PID == 4344 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 1097
drop if PID == 4344 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 2857
drop if PID == 4344 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 225
drop if PID == 4344 & year == 1942 & gdename == "rickenbach (sg)" & gdenr_2018_3c == 2582
drop if PID == 2004 & year == 1933 & gdename == "rickenbach (tg)" & gdenr_2018_3c == 225
drop if PID == 2004 & year == 1933 & gdename == "rickenbach (tg)" & gdenr_2018_3c == 2857
drop if PID == 2004 & year == 1933 & gdename == "rickenbach (tg)" & gdenr_2018_3c == 2582
drop if PID == 2004 & year == 1933 & gdename == "rickenbach (tg)" & gdenr_2018_3c == 1097
drop if PID == 55465 & year == 1972 & gdename == "rigi schiffahrtsgesellschaft ag, kilchberg" & gdenr_2018_3c == 135
drop if PID == 55465 & year == 1972 & gdename == "rigi schiffahrtsgesellschaft ag, kilchberg" & gdenr_2018_3c == 2851
drop if PID == 2278 & year == 1942 & gdename == "rochefort (france)" & gdenr_2018_3c == 6413
drop if PID == 12972 & year == 1979 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 12982 & year == 1980 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 13503 & year == 1981 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 14137 & year == 1982 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 14853 & year == 1983 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 15319 & year == 1984 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 15824 & year == 1986 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 16102 & year == 1985 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 16475 & year == 1987 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 17659 & year == 1988 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 18831 & year == 1989 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 19843 & year == 1990 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 20864 & year == 1991 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 21334 & year == 1993 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 21385 & year == 1992 & gdename == "schmitten (albula)" & gdenr_2018_3c == 2305
drop if PID == 46103 & year == 1966 & gdename == "silvretta liegenschaften ag, kilchberg" & gdenr_2018_3c == 2851
drop if PID == 46103 & year == 1966 & gdename == "silvretta liegenschaften ag, kilchberg" & gdenr_2018_3c == 135
drop if PID == 24916 & year == 1959 & gdename == "st stephan, simmentaler kraftwerke ag, erlenbach" & gdenr_2018_3c == 151
drop if PID == 8486 & year == 1933 & gdename == "sursee (ag)" & gdenr_2018_3c == 1103
drop if PID == 34628 & year == 1965 & gdename == "teuf en allwell express food inc., st gallen" & gdenr_2018_3c == 3203
drop if PID == 32501 & year == 1963 & gdename == "teuf en city grund ag, st gallen" & gdenr_2018_3c == 3203
drop if PID == 4222 & year == 1933 & gdename == "teufen (freienstein) (zh)" & gdenr_2018_3c == 3024
drop if PID == 8471 & year == 1965 & gdename == "utimaco s.a., chene bourg" & gdenr_2018_3c == 6613
drop if PID == 35515 & year == 1965 & gdename == "zumikon rueegsegger ag, gossau" & gdenr_2018_3c == 3443
drop if PID == 35515 & year == 1965 & gdename == "zumikon rueegsegger ag, gossau" & gdenr_2018_3c == 115
drop if PID == 14133 & year == 1959 & gdename == "zurich, kuesnacht" & gdenr_2018_3c == 154
drop if PID == 16124 & year == 1961 & gdename == "zurich, kuesnacht" & gdenr_2018_3c == 154
drop if PID == 16974 & year == 1962 & gdename == "zurich, kuesnacht" & gdenr_2018_3c == 154
drop if PID == 17969 & year == 1963 & gdename == "zurich, kuesnacht" & gdenr_2018_3c == 154

// From manual checks: correct geo-info
// gdenr_2018_3c
replace gdenr_2018_3c = 5884 if PID == 1993 & year == 1933 & gdename == "corsier (vd)"
replace gdenr_2018_3c = 5884 if PID == 4327 & year == 1942 & gdename == "corsier (vd)"
replace gdenr_2018_3c = 5884 if PID == 5766 & year == 1933 & gdename == "corsier (vd)"
replace gdenr_2018_3c = 6621 if PID == 11809 & year == 1961 & gdename == "geneve., gallet et co s.a., la chaux de fonds"
replace gdenr_2018_3c = 356 if PID == 72 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 132 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 661 & year == 1933 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 1617 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 1633 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 2231 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 4276 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 4625 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 4831 & year == 1933 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 6756 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 6799 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 7160 & year == 1933 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 7229 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 7405 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 9248 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 10249 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 10585 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 10586 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 10732 & year == 1959 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 11743 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 12995 & year == 1959 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 13925 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 14428 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 17226 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 17467 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 17483 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 17510 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 17689 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 356 if PID == 17794 & year == 1942 & gdename == "muri (be)"
replace gdenr_2018_3c = 159 if PID == 9417 & year == 1961 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace gdenr_2018_3c = 159 if PID == 9868 & year == 1962 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace gdenr_2018_3c = 159 if PID == 10538 & year == 1963 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace gdenr_2018_3c = 159 if PID == 11061 & year == 1965 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace gdenr_2018_3c = 159 if PID == 11630 & year == 1966 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace gdenr_2018_3c = 992 if PID == 46808 & year == 1965 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 46808 & year == 1965 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 49020 & year == 1966 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 49020 & year == 1966 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 34107 & year == 1959 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 34107 & year == 1959 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 43921 & year == 1963 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 43921 & year == 1963 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace gdenr_2018_3c = 992 if PID == 25580 & year == 1959 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 25580 & year == 1959 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 29346 & year == 1961 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 29346 & year == 1961 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 2118 & year == 1959 & gdename == "wangen a. a, oberaargauische automobikurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 2118 & year == 1959 & gdename == "wangen a. a, oberaargauische automobikurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 31088 & year == 1962 & gdename == "wangen a. a, oberaargauische automobilkurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 31088 & year == 1962 & gdename == "wangen a. a, oberaargauische automobilkurse ag, wangen"
replace gdenr_2018_3c = 992 if PID == 22497 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 22497 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 22498 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 22498 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 25746 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 25746 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 25747 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 25747 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 27285 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 27285 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 27286 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 27286 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 28973 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 28973 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 28974 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 28974 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 30793 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 30793 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 30794 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 30794 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 32274 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 32274 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 32275 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 32275 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 28096 & year == 1959 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 28096 & year == 1959 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 34171 & year == 1962 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 34171 & year == 1962 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 36171 & year == 1963 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 36171 & year == 1963 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 38526 & year == 1965 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 38526 & year == 1965 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 40351 & year == 1966 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 40351 & year == 1966 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 32232 & year == 1961 & gdename == "wannen a. a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 992 if PID == 32232 & year == 1961 & gdename == "wannen a. a, r. schweizer co ag, wangen"
replace gdenr_2018_3c = 261 if PID == 25448 & year == 1963 & gdename == "zuerich. arbo tuerenfabrik ag, buchs"
replace gdenr_2018_3c = 261 if PID == 25448 & year == 1963 & gdename == "zuerich. arbo tuerenfabrik ag, buchs"
replace gdenr_2018_3c = 261 if PID == 25448 & year == 1963 & gdename == "zuerich. arbo tuerenfabrik ag, buchs"
replace gdenr_2018_3c = 261 if PID == 25448 & year == 1963 & gdename == "zuerich. arbo tuerenfabrik ag, buchs"

// E_CNTR_3c
replace E_CNTR_3c = 2554200 if PID == 1993 & year == 1933 & gdename == "corsier (vd)"
replace E_CNTR_3c = 2554200 if PID == 4327 & year == 1942 & gdename == "corsier (vd)"
replace E_CNTR_3c = 2554200 if PID == 5766 & year == 1933 & gdename == "corsier (vd)"
replace E_CNTR_3c = 2500000 if PID == 11809 & year == 1961 & gdename == "geneve., gallet et co s.a., la chaux de fonds"
replace E_CNTR_3c = 2603700 if PID == 72 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 132 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 661 & year == 1933 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 1617 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 1633 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 2231 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 4276 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 4625 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 4831 & year == 1933 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 6756 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 6799 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 7160 & year == 1933 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 7229 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 7405 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 9248 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 10249 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 10585 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 10586 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 10732 & year == 1959 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 11743 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 12995 & year == 1959 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 13925 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 14428 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 17226 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 17467 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 17483 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 17510 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 17689 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2603700 if PID == 17794 & year == 1942 & gdename == "muri (be)"
replace E_CNTR_3c = 2693800 if PID == 9417 & year == 1961 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace E_CNTR_3c = 2693800 if PID == 9868 & year == 1962 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace E_CNTR_3c = 2693800 if PID == 10538 & year == 1963 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace E_CNTR_3c = 2693800 if PID == 11061 & year == 1965 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace E_CNTR_3c = 2693800 if PID == 11630 & year == 1966 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace E_CNTR_3c = 2616400 if PID == 46808 & year == 1965 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 49020 & year == 1966 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 34107 & year == 1959 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 43921 & year == 1963 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 25580 & year == 1959 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 29346 & year == 1961 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 2118 & year == 1959 & gdename == "wangen a. a, oberaargauische automobikurse ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 31088 & year == 1962 & gdename == "wangen a. a, oberaargauische automobilkurse ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 22497 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 22498 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 25746 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 25747 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 27285 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 27286 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 28973 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 28974 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 30793 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 30794 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 32274 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 32275 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 28096 & year == 1959 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 34171 & year == 1962 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 36171 & year == 1963 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 38526 & year == 1965 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 40351 & year == 1966 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace E_CNTR_3c = 2616400 if PID == 32232 & year == 1961 & gdename == "wannen a. a, r. schweizer co ag, wangen"
replace E_CNTR_3c = 2683100 if PID == 25448 & year == 1963 & gdename == "zuerich. arbo tuerenfabrik ag, buchs"

// N_CNTR_3c
replace N_CNTR_3c = 1146700 if PID == 1993 & year == 1933 & gdename == "corsier (vd)"
replace N_CNTR_3c = 1146700 if PID == 4327 & year == 1942 & gdename == "corsier (vd)"
replace N_CNTR_3c = 1146700 if PID == 5766 & year == 1933 & gdename == "corsier (vd)"
replace N_CNTR_3c = 1117900 if PID == 11809 & year == 1961 & gdename == "geneve., gallet et co s.a., la chaux de fonds"
replace N_CNTR_3c = 1197700 if PID == 72 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 132 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 661 & year == 1933 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 1617 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 1633 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 2231 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 4276 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 4625 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 4831 & year == 1933 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 6756 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 6799 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 7160 & year == 1933 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 7229 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 7405 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 9248 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 10249 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 10585 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 10586 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 10732 & year == 1959 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 11743 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 12995 & year == 1959 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 13925 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 14428 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 17226 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 17467 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 17483 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 17510 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 17689 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1197700 if PID == 17794 & year == 1942 & gdename == "muri (be)"
replace N_CNTR_3c = 1235400 if PID == 9417 & year == 1961 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace N_CNTR_3c = 1235400 if PID == 9868 & year == 1962 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace N_CNTR_3c = 1235400 if PID == 10538 & year == 1963 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace N_CNTR_3c = 1235400 if PID == 11061 & year == 1965 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace N_CNTR_3c = 1235400 if PID == 11630 & year == 1966 & gdename == "uetikon a s, velowache unipol ag, kuesnacht"
replace N_CNTR_3c = 1231500 if PID == 46808 & year == 1965 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 49020 & year == 1966 & gdename == "wangen a. a, ersparniskasse des amtbezirks ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 34107 & year == 1959 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 43921 & year == 1963 & gdename == "wangen a. a, esparniskasse des amtsbezirks ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 25580 & year == 1959 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 29346 & year == 1961 & gdename == "wangen a. a, oberaareauische automobilkurse ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 2118 & year == 1959 & gdename == "wangen a. a, oberaargauische automobikurse ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 31088 & year == 1962 & gdename == "wangen a. a, oberaargauische automobilkurse ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 22497 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 22498 & year == 1959 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 25746 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 25747 & year == 1961 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 27285 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 27286 & year == 1962 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 28973 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 28974 & year == 1963 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 30793 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 30794 & year == 1965 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 32274 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 32275 & year == 1966 & gdename == "wangen a. a, obrecht co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 28096 & year == 1959 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 34171 & year == 1962 & gdename == "wangen a. a, r. schweizer co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 36171 & year == 1963 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 38526 & year == 1965 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 40351 & year == 1966 & gdename == "wangen a.a, r. schweizer co ag, wangen"
replace N_CNTR_3c = 1231500 if PID == 32232 & year == 1961 & gdename == "wannen a. a, r. schweizer co ag, wangen"
replace N_CNTR_3c = 1247100 if PID == 25448 & year == 1963 & gdename == "zuerich. arbo tuerenfabrik ag, buchs"
