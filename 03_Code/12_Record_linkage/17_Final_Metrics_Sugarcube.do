...
insheet using ///
	"$path\02_Processed_data\12_Record_linkage\02_Sugarcube\sugarcube_test_set_randomized_buckets_0.65.csv", ///
	delim(",") clear
* a) Rename variables
...
keep id_0
save "$path\02_Processed_data\12_Record_linkage\02_Sugarcube\sugarcube_test_set_polids.dta", replace
restore
...
* matched to the same person in the Sugarcube data. 
duplicates drop id_0 id_1 year_1, force
* b) Keep only relevant variables
keep id_0 id_1 year_1 
