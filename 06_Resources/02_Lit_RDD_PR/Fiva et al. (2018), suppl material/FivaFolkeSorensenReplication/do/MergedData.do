...
foreach year in 1996 1997 1998 1999 2000 2001 2002 2003 2004 2005 2006 2007 {
sort knr year
merge knr year using ..\dta\Spredtbygd`year', update
tab _merge
drop _merge
}

gen Rural=spredtbygd/pop

keep if year<2011 /* MANGLER DATA FOR SISTE ÅR I VALGPERIODE 10 */

collapse PTAX120sqm pop Rural children young elderly Total_* PerCap* Herfindahl VoteNatLeft VoteShareLeft VoteShareRight VoteShareOther Balanced* cnr age06 age715 age1620 age2125 age2630 age3135 age3640 age4145 age4650 age5155 age5660 age6165 age6670 age7175 age7680 age81 unemployment women, by(knr electionperiod)


************************* DEMOGRAPHIC CONTROLS USE PREVIOUS ELECTION PERIOD VALUES *****************************************
xtset knr ele
sort knr ele
foreach var in pop Rural children young elderly unemployment {
gen lag`var'=l.`var'
}
...
saveold ..\dta\SpendingPanel, replace
...
saveold ..\dta\MergedDataBeforeCollapse, replace
...
drop if knr==1924 & ele==8  /* MISSING FISC. POLICY */
drop if knr==1928 & ele==9  /* MISSING FISC. POLICY */
drop if knr ==1576 & ele==10 /* missing INDEX */

sort knr ele
saveold ..\dta\MergedDataBeforeStandardizing, replace
...
gen laglogpop=log(lagpop)

sum lag*
/* STANDARDIZING */
foreach depvar in laglogpop lagRural lagchildren lagyoung lagelderly lagunemployment by1911 {
egen SD`depvar'=sd(`depvar')
replace `depvar'=`depvar'/SD`depvar'
}
sum lag*

saveold ..\dta\MergedData, replace
