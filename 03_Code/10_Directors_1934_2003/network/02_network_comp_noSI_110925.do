...
foreach a of local agrp{
	preserve	
		keep if year == `a'
		save "$dump\02_Processed_data\10_Directors_1934_2003\26_Crosssections\Firms_`a'_noSI.dta", replace
	restore
	drop if year == `a'
}
...
use "$dump\02_Processed_data\10_Directors_1934_2003\26_Crosssections\Firms_`y'_noSI.dta", clear
...
save "$dump\02_Processed_data\10_Directors_1934_2003\11_Ownerlists\ownerlist_`y'_noSI.dta", replace
}
...
save "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\edgeliste_`y'_bipartite_noSI.dta", replace
export excel "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\edgeliste_`y'_bipartite_noSI.xlsx", replace firstrow(variables)
export delimited using "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\edgeliste_`y'_bipartite_noSI.csv", delimiter(";") replace
}
...
save "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_pers\pers_`y'_attribute_complete_noSI.dta", replace
export excel "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_pers\pers_`y'_attribute_complete_noSI.xlsx", replace firstrow(variables)
export delimited using "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\pers_`y'_attribute_complete_noSI.csv", delimiter(";") replace
}
...
save "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_comp\comp_`y'_attribute_complete_noSI.dta", replace
export excel "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_comp\comp_`y'_attribute_complete_noSI.xlsx", replace firstrow(variables)
export delimited using "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\comp_`y'_attribute_complete_noSI.csv", delimiter(";") replace
}
...
foreach y in 1934 1943 1960 1962 1963 1964 1965 1966 1969 1972 1975 1979 1980 1981 1982 1983 1984 1985 1986 1987 1988 1989 1990 1991 1992 1993 1994 1995 1996 1997 1998 1999 2000 2001 2002 2003 {
use "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\edgeliste_`y'_bipartite_noSI.dta", clear

merge m:1 N_id_sug using "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_pers\pers_`y'_attribute_complete_noSI.dta"
keep if _merge == 3
...
save "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_pers\pers_attribute_`y'_deduplicates_noSI.dta", replace
export excel "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_pers\pers_attribute_`y'_deduplicates_noSI.xlsx", replace firstrow(variables)
export delimited using "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\pers_attribute_`y'_deduplicates_noSI.csv", delimiter(";") replace
}
...
merge m:1 N_UCID using"$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_comp\comp_`y'_attribute_complete_noSI.dta"
keep if _merge == 3
...
save "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_comp\comp_attribute_`y'_deduplicates_noSI.dta", replace
export excel "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\Node_attribute_comp\comp_attribute_`y'_deduplicates_noSI.xlsx", replace firstrow(variables)
export delimited using "$dump\02_Processed_data\10_Directors_1934_2003\10_Network_Bipartite\comp_attribute_`y'_deduplicates_noSI.csv", delimiter(";") replace
}
