...
*foreach parti in RV SV DNA V SP KRF H FRP PP Indep1 Other1 JointL JointR1{
	...
	(hist margin_`parti' if LVoteShare`parti'!=0 & margin_`parti'>0 & margin_`parti'<0.01, start(0.0) width(0.001) freq bfcolor(gs5) blcolor(gs6)), xtitle("") ytitle("") title(`parti') legend(off) graphregion(color(white))
