...
*************** REGRESSIONS w LeftRight*********************

foreach depvar in DPTAX DPTAXres Fees childcare education elderlycare healthsocial culture transport centraladm {
eststo clear
ivregress 2sls `depvar' (LeftRightIndex=*treat_w_025*) *dum_w_025* LeftRightControl,  cluster(knr) first 
eststo
...
estadd local Polynom "Third"
estadd local Bandwidth "50"
esttab using ../tables/Table2_`depvar'.tex, replace style(tex) ar2 se b(%9.2f) se(%9.2f) star(* 0.10 ** 0.05 *** 0.01) drop(_cons *dum_w_* *first* *second* *third* *Control) ///
